	...
	<div class="box">
		<el-card class="box-card" style="height:auto">
			<el-breadcrumb separator-class="el-icon-arrow-right">
			   ...
			   <el-breadcrumb-item>设备分类管理</el-breadcrumb-item>
			</el-breadcrumb>
			<div class="filter">

				<el-button type="primary"  @click="addDeviceType">添加设备类别</el-button>
			...
			<el-container style="padding: 10px 25px 0 25px">
				<el-main>
                    ...
                    <el-table-column prop="icon" label="设备图标" min-width="15%" align="center"
						header-align="center">
                    ...
                    <el-table-column prop="count" label="设备数量(已派遣/待命中)" min-width="15%" align="center"
						header-align="center"></el-table-column>
			...
			<div style="color:white" v-if="showAddDeviceDialog">
				...
				>
					<div class="">
						<div class='c'>设备名称:<el-input v-model="ObjectNameAdd" clearable></el-input></div>
						<div class='c'>设备图标:
							<!-- <el-image style="width: 50px; height: 50px" :src="scope.row.icon" fit=""></el-image> -->
                        </div>
						<el-upload v-if="!uploaded"
						...
						<!-- <el-button type="primary" style="margin-top: 10px;" @click="addEquip">确认</el-button> -->
					</div>
				</el-dialog>
			</div>
	...
	export default {
	  ...
	  methods: {
		...
		uploadImg(){
			...
			this.formData.append("objectType", "equip");
        ...
        getObjectTypeList(){
			...
			this.$axios.request(options).then(function (response) {
             ...
             that.total=response.data.length;
				...
				that.selectedObjectTypeList=that.ObjectTypeList.slice(0, that.pageSize);
