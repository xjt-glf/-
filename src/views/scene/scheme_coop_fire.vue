<template>
    <div style="color:white" class="fa">
        <el-dialog
        title="云边协同"
        :visible.sync="schemeCoopFire_show"
        width="30%"
        :modal=false
        ...
        >
            ...
            <div class="">
                ...
                <div class="imgg" id="imgg" :style="{ 'height': dialogHeight*0.3724 + 'px'}">
                    <img id="img1" :src=Img1Url  style="position:absolute;z-index: 3;" alt="" class="image"  width="95%" height="auto">
                    <img id="img2" :src=Img2Url  style="position:absolute;z-index: 1;" alt="" class="image"  width="95%" height="auto">
                    <img id="img3" :src=Img3Url  style="position:absolute;z-index: 2;" alt="" class="image"  width="95%" height="auto">

                    <!-- <el-image id="img1" :src=Img1Url style="position:absolute;z-index: 3;"  class="image"  width="95%" height="auto"></el-image>
                    <el-image id="img2" :src=Img2Url style="position:absolute;z-index: 1"  class="image"  width="95%" height="auto"></el-image>
                    <el-image id="img3" :src=Img3Url style="position:absolute;z-index: 2"  class="image"  width="95%" height="auto"></el-image> -->

                </div>
                <div class="bottom">
                    <div class="bottom-left">
                        <input type="text"  class="inputt" disabled="disabled" :value=" '当前带宽: '+bandwidth +'Mbps'">

                        <input type="text"  class="inputt" disabled="disabled" value=" 任务类型: 云边协同 ">
                        ...
                        <input type="text"  class="inputt" disabled="disabled" :value=" '最低精确度(mAP): '+minScore">
                        <input type="text"  class="inputt" disabled="disabled" :value=" '最高精确度(mAP): '+maxScore">
                    ...
                    <div class="bottom-right">
                        ...
                        <div class="node-canvas" style="width:99%;height:172px;background-color: #F8F6ED;">
                            ...
                            <canvas id="activeNodeLineCanvas"   style="position:absolute;height:172px;width:271.02px;margin-left:5px"></canvas>
                            <canvas id="baseMapCanvas"   style="height:172px;width:271.02px;margin-left:5px"></canvas>
                            <!-- border:1px solid #d3d3d3; -->
                        </div>
                        <img v-show="false" id="comBoard" src="../../images/Scene/comboard.jpg">
                        <img v-show="false" id="calBoard" src="../../images/Scene/calboard.jpg">
...
export default {
    name: "scheduling_scheme_coop_fire",
    props: {
        schemeCoopFire_show:Boolean
    },
    data() {
        return {
            detectedImgUrl:null,
            ...
            Img3Url:null,
            Img3Element:null,
            // 多张图片重叠，轮流替换el-image的ImgUrl,同时控制隐藏,
            elImgChoose:1,
            exit:false,
            oldFrameNum:0,
            fps:0,
    ...
    methods: {
        changeShow(){
            ...
            this.$parent.showSchemeCoopFire();
        },
        initEchartsAndCanvas(){
            ...
            this.baseMapCanvasCtx.beginPath();this.baseMapCanvasCtx.moveTo(40,23 );this.baseMapCanvasCtx.lineTo(152, 30);this.baseMapCanvasCtx.stroke();
            ...
            this.baseMapCanvasCtx.drawImage(htmlImgElementUser,20,8,40,30);
            ...
            this.baseMapCanvasCtx.drawImage(htmlImgElementComputer,140,10,30,30);
        ...
        drawActiveNodeLine(activeNodeArray){
            ...
            let endNode=parseInt(activeNodeArray[0])-1;
            console.log(endNode);
            // // 开始绘制路径
            // this.activeNodeCanvasCtx.beginPath();
            // // 移动至起点
            ...
            // this.activeNodeCanvasCtx.stroke();
            // 绘制箭头
            this.drawActiveArrow(155, 30,this.nodePosition[endNode][0],this.nodePosition[endNode][1]);
        },
        resetStartTime(){
        ...
        async updateData(firstCall){
            if(firstCall){
                ...
                await this.$axios.request(options).then(res => {
                    ...
                    if(this.elImgChoose==1){
                        this.Img1Url=res.data.resultData.oss_img_path;
                        this.elImgChoose=2;
                        this.Img1Element.style.zIndex=3
                        this.Img2Element.style.zIndex=1
                        this.Img3Element.style.zIndex=2
                    }else if(this.elImgChoose==2){
                        this.Img2Url=res.data.resultData.oss_img_path;
                        this.elImgChoose=3;
                        this.Img1Element.style.zIndex=2
                        this.Img2Element.style.zIndex=3
                        this.Img3Element.style.zIndex=1
                    }else if(this.elImgChoose==3){
                        this.Img3Url=res.data.resultData.oss_img_path;
                        this.elImgChoose=1;
                        this.Img1Element.style.zIndex=1
                        this.Img2Element.style.zIndex=2
                        this.Img3Element.style.zIndex=3
                    }
                    ...
                    this.dataTransferVolumeChart.setOption(this.dataTransferVolumeChartOption);
                    this.adt=res.data.resultData.adt;
                    this.bandwidth=res.data.resultData.bandwidth;
                    this.minScore=res.data.resultData.min_score;
                    this.maxScore=res.data.resultData.max_score;
        ...
        getImgElement(){
            this.Img3Element=document.getElementById("imgg");
            console.log(this.Img3Element);
        }
    },
    mounted(){
        // 傻逼代码加载太慢，获取不到dom元素
        ...
        setTimeout(() => {
            ...
            this.Img1Element=document.getElementById("img1");
            this.Img2Element=document.getElementById("img2");
            this.Img3Element=document.getElementById("img3");
            console.log(this.Img1Element);
        }, 1000);
        // window.onresize = () => {
		// 	return (() => {
