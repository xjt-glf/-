<template>
    <div style="color:white" class="fa">
        <el-dialog
        title="单点"
        :visible.sync="schemeEdgeFire_show"
        width="30%"
        :modal=false
            ...
            <div class="">
                ...
                <div class="bottom">
                    <div class="bottom-left">
                        ...
                        <input type="text"  class="inputt" disabled="disabled" value=" 任务类型: 单点 ">
                    ...
                    <div class="bottom-right">
                        ...
                        <div class="node-canvas" style="width:99%;height:172px;background-color: #F8F6ED;">
                            ...
                            <canvas id="activeNodeLineCanvas1"   style="position:absolute;height:172px;width:271.02px;margin-left:5px"></canvas>
                            <canvas id="baseMapCanvas1"   style="height:172px;width:271.02px;margin-left:5px"></canvas>
                            <!-- border:1px solid #d3d3d3; -->
                        </div>
                        <img v-show="false" id="comBoard1" src="../../images/Scene/comboard.jpg">
                        <img v-show="false" id="calBoard1" src="../../images/Scene/calboard.jpg">
                        <img v-show="false" id="computer" src="../../images/Scene/computer.png">
                        <img v-show="false" id="user1" src="../../images/Scene/user.png">
                        <img v-show="false" id="edgeServer1" src="../../images/Scene/edgeServer.png">
                        <img v-show="false" id="router1" src="../../images/Scene/router.png">
                    </div>
                </div>
            </div>
...
export default {
    name: "scheduling_scheme_edge_fire",
    props: {
        schemeEdgeFire_show:Boolean,
    },
    data() {
        return {
            detectedImgUrl:null,
    ...
    methods: {
        changeShow(){
            ...
            this.$parent.showSchemeEdgeFire();
        },
        initEchartsAndCanvas(){
            ...
            // 初始化画布
            this.baseMapCanvasCtx=document.getElementById('baseMapCanvas1').getContext('2d');
            this.activeNodeCanvasCtx=document.getElementById('activeNodeLineCanvas1').getContext('2d');
            var htmlImgElementcomBoard=document.getElementById('comBoard1');
            var htmlImgElementcalBoard=document.getElementById('calBoard1');
            var htmlImgElementComputer=document.getElementById('computer');
            var htmlImgElementUser=document.getElementById('user1');
            var htmlImgElementEdgeServer=document.getElementById('edgeServer1');
            var htmlImgElementRouter=document.getElementById('router1');
        ...
        async updateData(firstCall){
            if(firstCall){
                ...
                await this.$axios.request(options).then(res => {
                    ...
                    console.log(res.data.resultData.time_delay);
                    // 绘制canvsa
                    var activeNodes=res.data.resultData.det_node.split(',')
                    // this.adt=res.data.resultData.
        ...
        drawActiveNodeRect(activeNodes){
            ...
            this.activeNodeCanvasCtx.strokeRect(this.nodeRectPositions[targetNode-1][0],this.nodeRectPositions[targetNode-1][1],120,40);
        },
    },
    mounted(){
        // 傻逼代码加载太慢，获取不到dom元素
        ...
        //         const targetNode = document.querySelector('.scheme-edge-fire');
