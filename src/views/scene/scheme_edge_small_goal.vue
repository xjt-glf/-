<template>
    <div style="color:white" class="fa">
        <el-dialog
        title="火灾检测"
        :visible.sync="schemeEdgeSmallGoal_show"
        width="30%"
        :modal=false
            ...
            <div class="">
                ...
                <div class="bottom">
                    <div class="bottom-left">
                        ...
                        <input type="text"  class="inputt" disabled="disabled" value=" 任务类型: 火灾检测 ">
                    ...
                    <div class="bottom-right">
                        ...
                        <div class="node-canvas" style="width:99%;height:172px;background-color: #F8F6ED;">
                            ...
                            <canvas id="activeNodeLineCanvas3"   style="position:absolute;height:172px;width:271.02px;margin-left:5px"></canvas>
                            <canvas id="baseMapCanvas3"   style="height:172px;width:271.02px;margin-left:5px"></canvas>
                            <!-- border:1px solid #d3d3d3; -->
                        </div>
                        <img v-show="false" id="comBoard3" src="../../images/Scene/comboard.jpg">
                        <img v-show="false" id="calBoard3" src="../../images/Scene/calboard.jpg">
                        <img v-show="false" id="wifiPoint3" src="../../images/Scene/wifiPoint.png">
                        <img v-show="false" id="user3" src="../../images/Scene/user.png">
                        <img v-show="false" id="edgeServer3" src="../../images/Scene/edgeServer.png">
                        <img v-show="false" id="router3" src="../../images/Scene/router.png">
                    </div>
                </div>
            </div>
...
export default {
    name: "scheduling_scheme_fire",
    props: {
        schemeEdgeSmallGoal_show:Boolean
    },
    data() {
        return {
            detectedImgUrl:null,
    ...
    methods: {
        changeShow(){
            ...
            this.$parent.showSchemeEdgeSmallGoal();
        },
        initEchartsAndCanvas(){
            ...
            // 初始化画布
            this.baseMapCanvasCtx=document.getElementById('baseMapCanvas3').getContext('2d');
            this.activeNodeCanvasCtx=document.getElementById('activeNodeLineCanvas3').getContext('2d');
            var htmlImgElementcomBoard=document.getElementById('comBoard3');
            var htmlImgElementcalBoard=document.getElementById('calBoard3');
            var htmlImgElementwifiPoint=document.getElementById('wifiPoint3');
            var htmlImgElementUser=document.getElementById('user3');
            var htmlImgElementEdgeServer=document.getElementById('edgeServer3');
            var htmlImgElementRouter=document.getElementById('router3');
            // 使画布重叠
    ...
    mounted(){
        ...
        //         const targetNode = document.querySelector('.scheme-edge-small-goal');
